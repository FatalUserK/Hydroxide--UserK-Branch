		...
		settings = {
			{
				...
				ui_description = "Adds Chemical Curiosities' Materials to the game",
				value_default = true,
			...
			},
			{
				...
				ui_description = "Adds Arcane Alchemy's Materials to the game",
				value_default = true,
				scope = MOD_SETTING_SCOPE_NEW_GAME,
			},
			{
				id = "AA_bloomium",
				ui_name = "Bloomium",
				ui_description = "Enables Bloomium",
				value_default = true,
				scope = MOD_SETTING_SCOPE_NEW_GAME,
			},
			{
