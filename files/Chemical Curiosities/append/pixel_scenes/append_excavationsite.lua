...
table.insert(g_gunpowderpool_01, {
	prob			= 0.5,
	material_file	= "mods/Hydroxide/files/pixel_scenes/excavationsite/gunpowderpool_01_blast.png",
...
table.insert(g_gunpowderpool_01, {
	prob			= 0.5,
	material_file	= "mods/Hydroxide/files/pixel_scenes/excavationsite/gunpowderpool_01_kindling.png",
	visual_file		= "data/biome_impl/excavationsite/gunpowderpool_01_visual.png",
	background_file	= "",
	is_unique		= 0,
	});
...
table.insert(g_gunpowderpool_02, {
	prob			= 0.5,
	material_file	= "mods/Hydroxide/files/pixel_scenes/excavationsite/gunpowderpool_02_blast.png",
...
table.insert(g_gunpowderpool_02, {
	prob			= 0.5,
	material_file	= "mods/Hydroxide/files/pixel_scenes/excavationsite/gunpowderpool_02_kindling.png",
	visual_file		= "data/biome_impl/excavationsite/gunpowderpool_02_visual.png",
	background_file	= "",
	is_unique		= 0,
	});	
...
table.insert(g_gunpowderpool_03, {
	prob			= 0.5,
	material_file	= "mods/Hydroxide/files/pixel_scenes/excavationsite/gunpowderpool_03_blast.png",
...
table.insert(g_gunpowderpool_03, {
	prob			= 0.5,
	material_file	= "mods/Hydroxide/files/pixel_scenes/excavationsite/gunpowderpool_03_kindling.png",
	visual_file		= "data/biome_impl/excavationsite/gunpowderpool_03_visual.png",
	background_file	= "",
	is_unique		= 0,
	});
...
table.insert(g_gunpowderpool_04, {
	prob			= 0.5,
	material_file	= "mods/Hydroxide/files/pixel_scenes/excavationsite/gunpowderpool_04_blast.png",
...
table.insert(g_gunpowderpool_04, {
	prob			= 0.5,
	material_file	= "mods/Hydroxide/files/pixel_scenes/excavationsite/gunpowderpool_04_kindling.png",
	visual_file		= "data/biome_impl/excavationsite/gunpowderpool_04_visual.png",
	background_file	= "",
	is_unique		= 0,
	});
