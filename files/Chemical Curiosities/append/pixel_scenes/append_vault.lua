...
table.insert(g_pixel_scene_01, {
	...
	visual_file		= "mods/Hydroxide/files/pixel_scenes/vault/hydroxidetank_visual.png",
	background_file	= "mods/Hydroxide/files/pixel_scenes/vault/hydroxidetank_background.png",
	is_unique		= 0
	});
	
table.insert(g_pixel_scene_02, {
	prob			= 1.0,
	material_file	= "mods/Hydroxide/files/pixel_scenes/vault/lab3.png",
	visual_file		= "mods/Hydroxide/files/pixel_scenes/vault/lab3_visual.png",
	background_file	= "mods/Hydroxide/files/pixel_scenes/vault/lab3_background.png",
	is_unique		= 0
	});
end
