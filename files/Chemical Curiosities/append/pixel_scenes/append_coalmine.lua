...
table.insert(g_pixel_scene_01, {
	...
	visual_file		= "mods/Hydroxide/files/pixel_scenes/coalmine/shrinekindling_visual.png",
	background_file	= "",
	is_unique		= 0
	});
...
table.insert(g_pixel_scene_02, {--TODO change 0.9 to lower numebr if this works
	prob			= 0.9,
	material_file	= "mods/Hydroxide/files/pixel_scenes/coalmine/mossPit.png",
	visual_file		= "mods/Hydroxide/files/pixel_scenes/coalmine/mossPit_visual.png",
	background_file	= "mods/Hydroxide/files/pixel_scenes/coalmine/mossPit_background.png",
	is_unique		= 0
	});
